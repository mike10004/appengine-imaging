...
import com.gaecompat.javax.swing.BoundedRangeModel;
import com.gaecompat.javax.swing.SwingConstants;
import com.gaecompat.javax.swing.text.AbstractDocument;
import com.gaecompat.javax.swing.text.AbstractDocumentI;
import com.gaecompat.javax.swing.text.AttributeSet;
import com.gaecompat.javax.swing.text.BadLocationException;
import com.gaecompat.javax.swing.text.DateFormatter;
import com.gaecompat.javax.swing.text.Document;
import com.gaecompat.javax.swing.text.Element;
import com.gaecompat.javax.swing.text.MutableAttributeSet;
import com.gaecompat.javax.swing.text.PlainDocument;
import com.gaecompat.javax.swing.text.Position;
import com.gaecompat.javax.swing.text.Segment;
import com.gaecompat.javax.swing.text.StyleConstants;
import com.gaecompat.javax.swing.text.StyledDocument;
import com.gaecompat.javax.swing.text.TabExpander;
import com.gaecompat.javax.swing.text.View;
import com.gaecompat.javax.swing.text.Position.Bias;
...
//  TODO remove this method as duplicate
    ...
    public static final boolean isBidirectional(final Document document) {
        ...
        Element bidiRoot = ((AbstractDocumentI)document).getBidiRootElement();
   ...
   public static final int getWordStart(final TextKit tk, final int pos)
    ...
    public static final Element getParagraphElement(final Document doc,
        ...
        if (doc instanceof AbstractDocument) {
            AbstractDocumentI abstrDoc = (AbstractDocumentI) doc;
            abstrDoc.readLock();
            Element elem = null;
            int length = 0;
    ...
    public static final void readLock(final Document document) {
        if (document instanceof AbstractDocument) {
            ((AbstractDocumentI)document).readLock();
        }
    }

    public static final void readUnlock(final Document document) {
        if (document instanceof AbstractDocument) {
            ((AbstractDocumentI)document).readUnlock();
        }
    }
